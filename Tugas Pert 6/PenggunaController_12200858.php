...
use App\Models\Pengguna12200858;
use Config\Services;

class PenggunaController_12200858 extends BaseController
{
    public function index()
    {
        return view('halaman/pengguna/table', [
            'xx'    => (new Pengguna12200858())->get()->getResult(),
    ...
    public function simpan(){
        ...
        if( $this->validasi() ){
            $r = (new Pengguna12200858())->insert($data);
            if($r == false){
    ...
    public function edit($id){
        $data = (new Pengguna12200858())->where('id', $id)->first();
    ...
    public function patch(){
        ...
        if( $this->validasiPatch() ){
            $r = (new Pengguna12200858())->update($id, $data);
            if($r == true){
                return redirect()->to('/pengguna-list');
            }else{
    ...
    public function delete(){
        $id = $this->request->getPost('id');
        $r = (new Pengguna12200858())->delete($id);
